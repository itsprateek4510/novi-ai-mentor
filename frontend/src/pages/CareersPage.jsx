...
export default function CareersPage() {
  ...
  const matchCard = (m, i) => (
    <div key={m.career.slug} className="list-item mb" style={{ cursor: "pointer" }} onClick={() => navigate(`/career/${m.career.slug}`)}>
      <div className="row">
  ...
  return (
    <>
      ...
      <div className="career-grid" id="career-grid">
        {filtered.map((c) => (
          <div key={c.slug} className="card career-card" onClick={() => navigate(`/career/${c.slug}`)}>
