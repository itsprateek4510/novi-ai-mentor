...
import { api, applyAccent, esc, fmtJoined, initials, NOVI_ACCENTS, PS_NOTIFS, readPrefs, refreshDnaContext, savePrefs } from "../api";
      ...
      <div className="ps-layout">
        <aside className="ps-side">
          <div className="ps-side-group">
            ...
            <hr className="ps-sep" />
            <button className="ps-item danger" id="ps-signout" onClick={() => { localStorage.removeItem("novi_token"); localStorage.removeItem("novi_user"); window.location.hash = "#/"; window.location.reload(); }}>
