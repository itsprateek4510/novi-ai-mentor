...
export default function UniversitiesPage() {
  ...
  const uniCard = (u) => {
    ...
    return (
      <div key={u.slug} className="card list-item u-card" data-slug={u.slug} style={{ cursor: "pointer" }} onClick={() => navigate(`/university/${u.slug}`)}>
  ...
  const uniReadinessCard = (m) => (
    <div key={m.university?.slug || m.id} className="card list-item" style={{ cursor: "pointer" }} onClick={() => m.university?.slug && navigate(`/university/${m.university.slug}`)}>
